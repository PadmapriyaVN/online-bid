// Purpose: This model will be used to interact with the user_profiles table in the database. 
//This model will be used by the application to perform CRUD operations on the user_profiles table. 
